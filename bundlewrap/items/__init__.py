...
from bundlewrap.utils.dicts import dict_to_text, diff_dict, hash_actual_state, validate_actual_state
...
class Item:
    ...
    def cached_expected_state(self):
        ...
        try:
            validate_actual_state(expected_state)
    ...
    def hash(self):
        return hash_actual_state(self.cached_expected_state)
