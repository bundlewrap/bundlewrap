...
A Python module called :file:`example.py` placed in this directory will be available as ``repo.libs.example`` wherever you have access to a :py:class:`blockwart.repo.Repository` object.
