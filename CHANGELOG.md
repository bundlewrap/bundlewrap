...
* terminology: `cdict` and `sdict` have been renamed to `expected_state` and `actual_state`, and they need `@property` now; this affects custom bundles (BACKWARDS INCOMPATIBLE)
