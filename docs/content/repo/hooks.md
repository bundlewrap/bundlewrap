...
Called once for every usage of a key from [`.secrets.cfg`](../guide/secrets.md).
Basically this means this hook will get called every time a Fault generated by `repo.vault` is resolved.
