...
from blockwart.items import svc_systemv
from blockwart.operations import RunResult


class AskTest(TestCase):
    """
    Tests blockwart.items.svc_systemv.SvcSystemV.ask.
    """
    def test_start(self):
...
class FixTest(TestCase):
    """
    Tests blockwart.items.svc_systemv.SvcSystemV.fix.
    """
    def test_start(self):
        node = MagicMock()
...
class GetStatusTest(TestCase):
    """
    Tests blockwart.items.svc_systemv.SvcSystemV.get_status.
    """
    @patch('blockwart.items.svc_systemv.svc_running')
...
class svcrunningTest(TestCase):
    """
    Tests blockwart.items.svc_systemv.svc_running.
    """
...
class ValidateAttributesTest(TestCase):
    """
    Tests blockwart.items.svc_systemv.SvcSystemV.validate_attributes.
    """
