...
class PlotTest(TestCase):
    ...
    def test_output(self):
        ...
        self.assertEqual(
            ...
            "\"type3:item1\"\n"
            "}\n"
            "\"type1:\" -> \"type1:item1\" [color=\"#6BB753\"]\n"
            "\"type1:\" -> \"type1:item2\" [color=\"#6BB753\"]\n"
            "\"type3:\" -> \"type3:item1\" [color=\"#6BB753\"]\n"
            "\"type2:\" -> \"type2:item1\" [color=\"#6BB753\"]\n"
            "\"type2:item1\" -> \"type1:item1\" [color=\"#C24948\"]\n"
            "\"type3:item1\" -> \"type2:\" [color=\"#3991CC\"]\n"
            "fontsize = 28\n"
            "label = \"node\"\n"
            "labelloc = \"t\"\n"
            "}"
